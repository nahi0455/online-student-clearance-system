...
// ✅ Access control: Only Department Heads can access this page
...
if (isset($_GET['filter'])) {
  $f = $_GET['filter'];
  if ($f === 'approved') { $query_students .= " AND is_department_approved = 1"; }
  if ($f === 'pending') { $query_students .= " AND is_department_approved = 0"; }
}
...
<style>
/* Modern Department Admin Styling */
:root {
...
@media (max-width: 768px) {
  ...
  img.img-circle { width: 40px; height: 40px; }
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">
                <a href="../dynamic/law.php" class="d-block"> STUDENT LAW </a>
         </a>
        </div>
      </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column">
            ...
            <li class="nav-item">
              <a href="index.php?dept=<?php echo $dept; ?>" class="nav-link">
