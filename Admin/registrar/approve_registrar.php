...
if (isset($_POST['btnapprove'])) {
    ...
    if ($row['is_department_approved'] != '1') {
        ...
        header("Location: dormitory_clearance.php");
        exit();
    }

    // ✅ If approved, proceed with library approval
    $query = "UPDATE students SET is_registrar_approved='1' WHERE ID='$id'";
    mysqli_query($conn, $query);

    $_SESSION['success'] = "✅ registrar clearance approved successfully!";
