...
if ($filter == 'approved') { $query_students .= " AND is_police_approved = 1"; }
elseif ($filter == 'ready') { $query_students .= " AND is_police_approved = 0 AND is_dean_approved = 1"; }
elseif ($filter == 'pending') { $query_students .= " AND is_police_approved = 0 AND is_dean_approved = 0"; }
...
<head>
<meta charset="utf-8">
<title>police | <?php echo $dept; ?> Department</title>
    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column">
            ...
            <li class="nav-item">
              <a href="../police/police.php?dept=<?php echo $dept; ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="police.php?dept=<?php echo $dept; ?>&view=session" class="nav-link">
...
<li class="nav-item">
  <a href="police.php?dept=<?php echo $dept; ?>&filter=ready" class="nav-link">
...
<li class="nav-item">
  <a href="police.php?dept=<?php echo $dept; ?>&filter=pending" class="nav-link">
...
<li class="nav-item">
  <a href="police.php?dept=<?php echo $dept; ?>&filter=approved" class="nav-link">
...
} elseif (!$row['is_police_approved']) {
    echo "<form method='POST' action='approve_police.php' style='display:inline-block;'>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (sessionSelect) {
    sessionSelect.addEventListener('change', function () {
      const v = this.value;
      const urlBase = 'police.php?dept=<?php echo $dept; ?>&view=session';
