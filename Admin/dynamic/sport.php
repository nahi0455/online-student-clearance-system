...
if ($filter == 'approved') { $query_students .= " AND is_sport_approved = 1"; }
elseif ($filter == 'ready') { $query_students .= " AND is_sport_approved = 0 AND is_cafeteria_approved = 1"; }
elseif ($filter == 'pending') { $query_students .= " AND is_sport_approved = 0 AND is_cafeteria_approved = 0"; }
...
<head>
<meta charset="utf-8">
<title>sport Dashboard | <?php echo $dept; ?> Department</title>
    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column">
                     <li class="nav-item">
              <a href="../sport/sport.php?dept=<?php echo $dept; ?>" class="nav-link">
                <i class="nav-icon fas fa-home"></i>
                <p>Dashboard</p>
              </a>
            </li>
        <li class="nav-item">
            <a href="sport.php" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p>Students Under Department</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="sport.php?dept=<?php echo $dept; ?>&view=session" class="nav-link">
              <i class="nav-icon fas fa-calendar-alt"></i>
              <p>Session</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="sport.php?dept=<?php echo $dept; ?>&filter=ready" class="nav-link">
              <i class="nav-icon fas fa-clipboard-check"></i>
              <p>Ready To Approve</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="sport.php?dept=<?php echo $dept; ?>&filter=pending" class="nav-link">
              <i class="nav-icon fas fa-clock"></i>
              <p>Pending</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="sport.php?dept=<?php echo $dept; ?>&filter=approved" class="nav-link">
...
<td>
   <a href='leave_details.php?id=".$row['ID']."'>
    ...
    // Approval button
if (!$row['is_cafeteria_approved']) {
    echo "<button class='btn btn-warning btn-sm' disabled>
            waiting 
          </button>";
} elseif (!$row['is_sport_approved']) {
    echo "<form method='POST' action='approve_sport.php' style='display:inline-block;'>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (sessionSelect) {
    sessionSelect.addEventListener('change', function () {
      const v = this.value;
      const urlBase = 'sport.php?dept=<?php echo $dept; ?>&view=session';
