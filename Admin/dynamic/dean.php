...
if ($filter == 'approved') { $query_students .= " AND is_dean_approved = 1"; }
elseif ($filter == 'ready') { $query_students .= " AND is_dean_approved = 0 AND is_sport_approved = 1"; }
elseif ($filter == 'pending') { $query_students .= " AND is_dean_approved = 0 AND is_sport_approved = 0"; }
...
<head>
<meta charset="utf-8">
<title>Dean | <?php echo $dept; ?> Department</title>
      ...
      <span class="brand-text">BULE HORA UNIVERSITY<br><small><?php echo $dept; ?></small></span>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column">
            ...
            <li class="nav-item">
              <a href="../dean/dean.php?dept=<?php echo $dept; ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="dean.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="dean.php?dept=<?php echo $dept; ?>&view=session" class="nav-link">
...
<li class="nav-item">
  <a href="dean.php?dept=<?php echo $dept; ?>&filter=ready" class="nav-link">
...
<li class="nav-item">
  <a href="dean.php?dept=<?php echo $dept; ?>&filter=pending" class="nav-link">
...
<li class="nav-item">
  <a href="dean.php?dept=<?php echo $dept; ?>&filter=approved" class="nav-link">
...
<td>
   <a href='leave_details.php?id=".$row['ID']."'>
    ...
    // Approval button
if (!$row['is_sport_approved']) {
    echo "<button class='btn btn-warning btn-sm' disabled>
            waiting 
          </button>";
} elseif (!$row['is_dean_approved']) {
    echo "<form method='POST' action='approve_dean.php' style='display:inline-block;'>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (sessionSelect) {
    sessionSelect.addEventListener('change', function () {
      const v = this.value;
      const urlBase = 'dean.php?dept=<?php echo $dept; ?>&view=session';
