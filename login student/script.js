...
class NeumorphismLoginForm {
    constructor() {
        ...
        this.matricInput = document.getElementById('matric_no');
    ...
    bindEvents() {
        ...
        if (this.matricInput) {
            this.matricInput.addEventListener('blur', () => {/* optional field validation */});
            this.matricInput.addEventListener('input', () => {/* clear errors if any */});
        }
        if (this.passwordInput) {
            this.passwordInput.addEventListener('blur', () => {/* optional field validation */});
            this.passwordInput.addEventListener('input', () => {/* clear errors if any */});
        }
        
        // Add soft press effects to inputs
        [this.matricInput, this.passwordInput].forEach(input => {
            if (!input) return;
    ...
    async handleSubmit(e) {
        // allow native form submission to PHP handler
