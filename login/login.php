...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form class="login-form" role="form" method="POST" action="" novalidate>

                <div class="form-group">
                    <div class="input-group neu-input">
                        <input type="text" id="matric_no" name="txtmatric_no" required autocomplete="off" placeholder=" ">
                ...
                <div class="form-group">
                    <div class="input-group neu-input password-group">
                        <input type="password" id="password" name="txtpassword" required autocomplete="off" placeholder=" ">
                ...
                <button type="submit" name="btnlogin" class="neu-button login-btn">
